...
feature_gen.add_function('gc_content', 20) # usage of GC content feature. NUM means how many bins 
...
my_classifier = lib_classifier.My_Classifier(feature_gen, 'tree', [100,1,'sigmoid']) # create a classifier 
