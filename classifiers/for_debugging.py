...
feature_gen.add_function('gc_content', 4) # usage of GC content feature. NUM means how many bins 
...
feature_gen.add_function('motif_score', ['motif2.motif', '']) 
#feature_gen.add_function('motif_score', ['motif3.motif','-b']) 
feature_gen.add_function('motif_score', ['motif4.motif', '']) 
feature_gen.add_function('rna_struct', 10) # usage of RNA secondary structure feature. NUM means the length of the sequence you want to analyze the structure. more details are in lib_classifier


my_classifier = lib_classifier.My_Classifier(feature_gen, 'pip_svm', [10,1,'sigmoid']) # create a classifier 
