...
feature_gen.add_function('rna_struct', 10) # usage of RNA secondary structure feature. NUM means the length of the sequence you want to analyze the structure. See the following details
...
my_classifier = lib_classifier.My_Classifier(feature_gen, 'svm', [100,1,'linear']) # create a classifier 
