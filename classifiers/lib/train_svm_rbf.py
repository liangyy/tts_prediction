...
if len(sys.argv) == 1:
	...
	print
	print('USAGE:')
	print('python train_svm_rbf.py [training_set] [motif_path] [save_classifier_as] [output_report]')
	# print
...
my_classifier = lib_classifier.My_Classifier(feature_gen, 'svm', [100, 0.0001, 'rbf'], path) # create a classifier 								
# (raw_data, labels) = data_read(raw_data) 
