...
if len(sys.argv) == 1:
	...
	print
	print('USAGE:')
	print('python cv_tree.py [training_set] [motif_path] [fold] [output_report]')
	# print
...
for i in c:
	...
	my_classifier = lib_classifier.My_Classifier(feature_gen, 'tree', [i], path) # create a classifier 								
