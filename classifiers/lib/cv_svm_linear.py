...
if len(sys.argv) == 1:
	...
	print
	print('USAGE:')
	print('python cv_svm_linear.py [training_set] [motif_path] [fold] [output_report]')
	# print
...
for i in c:
	print '------------------------'
	print 'C =', i
	my_classifier = lib_classifier.My_Classifier(feature_gen, 'svm', [i, 1, 'linear'], path) # create a classifier 								
