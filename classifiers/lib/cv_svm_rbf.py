...
if len(sys.argv) == 1:
	...
	print
	print('USAGE:')
	print('python cv_svm_rbf.py [training_set] [motif_path] [fold] [output_report]')
	# print
...
for g in gamma:
	for i in c:
		print '------------------------'
		print 'gamma =', g, '  C =', i
		my_classifier = lib_classifier.My_Classifier(feature_gen, 'svm', [i, g, 'rbf'], path) # create a classifier 								
